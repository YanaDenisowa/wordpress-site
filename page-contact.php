...
<main>
	...
	<!--                    <form action="#" class="form">-->
							<?php echo apply_shortcodes( '[contact-form-7 id="122" title="Contact"]');?>
	...
	<!--                    </form>-->
					...
					<div class="aftersubmit__message">
						<div class="aftersubmit__message__body">
							<p class="descr"><b><?php echo get_field('aftersubmit_text_1');?></b></p>
							<p class="descr"><?php echo get_field('aftersubmit_text_2');?></p>
							<div class="aftersubmit__btn__wrap">
								<a class="link" href="<?php echo get_field('aftersubmit_button')['url']?>"> <?php echo get_field('aftersubmit_button')['title']?> </a>
							</div>
						</div>
					</div>
				</div>
